...
public class Constants {
    ...
    public static final String ALLVACCINATEDDATAPATH = "src/Testing CSV files/owid-covid-dataVF(CSV).csv";

    public static final String PARAMS_FILENAME = "config.properties";
    public static final String PARAMS_COMPANY_DESIGNATION = "Company.Designation";
    public static final String PARAMS_DAILY_TIMER = "Daily.Timer";

    public static final String LEGACY_VACC_CENTER = "National Center do Porto";

    public static int TOTAL_MINUTES=720;
    public static String OPEN_HOUR="8:00";
    
    public static final String LEGACY_VACC_NAME = "National Center of Porto - Vaccination Center";
    ...
    public static final String TECH_6_TYPE = "When an mRNA vaccine is delivered, the RNA material\n" +
            ...
            "the body would like have the tools (antibodies) to fight against it.";
