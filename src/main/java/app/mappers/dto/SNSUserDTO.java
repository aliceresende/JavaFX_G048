...
*       */
    public SNSUserDTO(String name, String sex, String birthDate, Address address, String phoneNumber, String email, String snsUserNumber, String citizenCardNumber) {
        this.name = name;
        this.sex = sex;
