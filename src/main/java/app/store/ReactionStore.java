...
public class ReactionStore {
    ...
    public Reactions createReaction(String snsnumber,String sns_name,String allergy,String Vaccine_reaction,String anaphylactic_reaction,String blood_clotting_disorders,
                                String immunodeficiency, String chemo, String this_vaccine){
        this.react = new Reactions(snsnumber, sns_name, allergy, Vaccine_reaction, anaphylactic_reaction, blood_clotting_disorders,
