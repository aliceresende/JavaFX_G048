...
public class RequestVaccineUI implements Runnable{
    ...
    /**
     * Asks the information of the vaccine schedule and reads it
    ...
    public void run() {
        ...
        List<Vaccine> vaccine = vaccineSC.GetVaccineList();
        ...
        List<ComunityMassVaccinationCenter> vaccinationCenter = vaccineSC.GetVaccinationCenterList();
    ...
    public List<String> vaccinationCenterName(List<ComunityMassVaccinationCenter> vaccinationCenter) {
        ...
        for(ComunityMassVaccinationCenter cmvc : vaccinationCenter) {
            vaccinationCenterName.add(cmvc.getName());
        }
